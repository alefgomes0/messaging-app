...
export const ContactCard = ({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        `min-h-[90px] w-full grid grid-cols-[60px_1fr] grid-rows-2 items-center gap-x-4 gap-y-1 cursor-pointer text-neutral-800 dark:text-neutral-200 rounded-md ${
          isActive ? "bg-zinc-200 dark:bg-[#333]" : ""
        } hover:bg-zinc-200 dark:hover:bg-neutral-700 transition-colors px-3 `
      }
    >
      {profilePicture ? (
        <img
